...
# print(session_app.data)
# session_app.data = {'user_id':'lst'}
# session_app.refresh()
# print(session_app.data)
# with get_session() as s:
#     data = s.query(session_db).filter(session_db.id == '7cfcc5ec-7406-4963-997f-48ab2ba8d7aa',
#                                                 session_db.deleted_at==None).first().dobule_to_dict()['data']
#     print(data)